...
namespace ImGui
{
    ...
    static void processCurrentFrame(FrameIndexType* frame, ImGuiNeoSequencerInternalData& context)
    {
        ...
        ImGuiItemFlags itemFlags = ImGuiItemFlags_None;
        const auto hovered = ItemHoverable(pointerRect, GetCurrentWindow()->GetID("##_top_selector_neo"), itemFlags);
...
//
        ...
        *end = endFrameVal;
        ...
        ImGuiItemFlags itemFlags = ImGuiItemFlags_None;
        const bool hovered = ItemHoverable(bb, GetCurrentWindow()->GetID("##zoom_slider"), itemFlags);

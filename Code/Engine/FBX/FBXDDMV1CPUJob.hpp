...
class FBXDDMV1CPUJob : public Job {
public:
	FBXDDMV1CPUJob(class FBXDDMModifierCPU& modifierCPU, unsigned int ctrlPointIdx, const std::vector<Eigen::Matrix<double, 4, 4>>& allJointTransformsEigen);
